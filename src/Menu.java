...
public class Menu extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 60, 20));
        ...
        jPanel1.add(resultField, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 280, 150, 40));
        ...
        bt_back.setBackground(new java.awt.Color(51, 0, 102));
        bt_back.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void bt_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_backActionPerformed
      ...
      BookAction bookAction= new BookAction();
       id= Integer.parseInt(resultField.getText());
